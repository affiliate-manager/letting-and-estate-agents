...
export const ICONS = {
  ...
  agentFinderLogo: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="af-logo-icon"><circle cx="50" cy="50" r="50" fill="#FF9C00"/><g fill="none" stroke="#fff" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"><circle cx="43" cy="43" r="18"/><path d="M55 55l14 14"/><path d="M35 46V38l8-7 8 7v8" stroke-width="4"/></g></svg>`,
